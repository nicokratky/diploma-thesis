...
\author{Nico Kratky}
%
FaPS, which stands for Filtering and Preprocessing System, is an application that reads digital sensor output, preprocesses it and forwards it to another process to distribute it to the final clients. It also saves the readout to HDF5 files \autocite{HDF5}.
